			...
			<?php
				...
				else 
			 {
			  ...
			  while($row = mysqli_fetch_array($contents)) 
			  {
				...
				$contents_collection = mysqli_query($connection, "SELECT * FROM collection WHERE SetID LIKE '$SetID'");//detta är alla bitar i samlingen
			  ...
			  if(mysqli_num_rows($contents_collection) === 0) //Om bitar i samling inte finns 
			 {
				print("<p id = 'missing'>Bitar saknas i din samling.</p>\n");
			 } 
